        ...
        echo("<html>
                <body>
                    <form role='form' class='horizontal'>
                        ...
                        <br/><br/><br/><br/>
                        <div class='col-xs-2'>
                      <a href='checkOutEquipment.php?id=$user_id&equipment_id=$e_id&date_booked=$date_booked&date_returned=$return_date> <button type='submit' class='btn btn-default'>Submit</button></a>
                        </div>
                    </form>
                </body>
            </html>
